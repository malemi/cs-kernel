...
step "27. every agent reads the same project skills"
...
step "36. cs-review — the ONE skill, and the kill-switch is state, not news"
...
step "57. an HTML-escaped message id is the same conversation"
...
step "58. sending a draft retires its Gmail mirror"
